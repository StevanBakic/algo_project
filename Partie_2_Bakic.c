...
/* rend la liste des permutations de [1..n]*/
Tab Permutations(int n);
/* Ajoute Toute Liste Toute Position */
Tab ATLTP(int x, Tab l);

Tab Concat( Liste L1, Liste L2);

/* Ajoute Toute Position */
Tab ATP(int x, Liste l);

/* Ajoute En Tete Toute Liste */
Tab AETTL( int x, Tab l);
...
/* rend vrai si et seulement elle a un 0 en deuxieme position */
bool zdp(Liste l){
...
/* rend vrai ssi tout  ́el ́ement apparaissant dans cette liste est un 0 */
...
/*rend le nombre de 0 qui se trouvent en debut de liste*/
int recCZI(Liste l){
...
/* rend la liste triee des  elements communs aux deux listes */
...
/*elimine les k premieres occurences de x dans la liste*/
...
/*elimine les k dernieres occurences de x dans la liste*/
...
/*  gcc -Wall -o Partie_2_Bakic_Sinapi Partie_2_Bakic_Sinapi.c  */
...
int main(int argc, char** argv)
{
   Liste l ;
        ...
        ElimineKpremiersX(& l, 3, 7);
        //ElimineKderniersX(& l, 3, 7);
